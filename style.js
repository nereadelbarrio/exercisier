...
(function (blink) {
	...
	exercisierStyle.prototype = {
		...
		formatCarouselindicators: function (scope, classNavbar) {
			var that = scope || this,
				navbar = ((typeof classNavbar !== "undefined" && classNavbar)?classNavbar:'exercisier-navbar'),
	...
	exercisierStyle.prototype = _.extend({}, new blink.theme.styles.basic(), exercisierStyle.prototype);
